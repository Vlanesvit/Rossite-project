...
import { isMobile, _slideUp, _slideDown, _slideToggle, vnv } from "../files/functions.js";
...
class SelectConstructor {
	...
	// Логгинг в консоль
	setLogging(message) {
		this.config.logging ? vnv(`[select]: ${message}`) : null;
	}
}
// Запускаем и добавляем в объект модулей
vnvModules.select = new SelectConstructor({});
