...
export function ajax_project(action, checkedYear = [], checkedCity = [], checkedIndustry = [], checkedType = [], loadmore = false) {
...
document.addEventListener('projectsUpdated', () => {
	...
	if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
		...
		console.log('GSAP и ScrollTrigger обновлен после загрузки проектов');
	} else {
		console.log('GSAP или ScrollTrigger не инициализированы.');
	}
});